...
> 如需前后端分离版本，请移步 [Education-Vue](https://gitee.com/y_project/Education-Vue)

> 如需单应用，请移步 [Education-fast](https://gitee.com/y_project/Education-fast)  `(保持同步更新)`，如需其他版本，请移步 [项目扩展](http://doc.education.vip/education/document/xmkz.html)  `(不定时更新)`
...
演示地址：http://education.vip  

文档地址：http://doc.education.vip
